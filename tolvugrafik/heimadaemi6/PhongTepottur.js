...
var discardCutoffLoc;
var diffuseProductLoc;
var discardCutoff = 1.8;
var diffuseProduct;
...
window.onload = function init() {
    ...
    discardCutoffLoc = gl.getUniformLocation( program, "discardCutoff" );
    ...
    gl.uniform1f( discardCutoffLoc, discardCutoff );
    ...
    // Event listener for mousewheel
     ...
     window.addEventListener("keydown", function(e){
      switch( e.keyCode ) {         
          case 38:    // up arrow
              e.preventDefault();
              discardCutoff = Math.min((discardCutoff+0.1), 4.0);
              break;
          case 40:    // down arrow
              e.preventDefault();
              discardCutoff = Math.max((discardCutoff-0.1), 1.0);
              break;
          case 37:    // left arrow
...
function render() {
    ...
    let r = Math.floor(color/100)*0.1 + 0.1;
    let g = Math.floor(color/10)%10*0.1 + 0.1;
    let b = color % 10*0.1 + 0.1;
