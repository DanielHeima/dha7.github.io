...
let flagNegativeVert = 0; // hæst 0, lægst 2
...
function quad(a, b, c, d) 
{
    ...
    for ( var i = 0; i < indices.length; ++i ) {
      cVertices.push( vertices[indices[i]] );        
    }
}
     ...
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 40:	// niður ör
                ...
                break;
            case 33: // pgUp
                if (flagNegativeVert > 0) {
                  flagNegativeVert -= 0.1;
                }
                break;
            case 34: // pgDwn
                if (flagNegativeVert < 2) {
                  flagNegativeVert += 0.1;
                }
                break;
         }
...
var render = function(){
    ...
    gl.useProgram(program2);
    mv2 = mult( mv2, translate(0.16, 1.0-flagNegativeVert, 0.0) );
