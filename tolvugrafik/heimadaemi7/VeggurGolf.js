...
var vertices = [
  ...
  vec4(-50.0, 0.0, 0.0, 1.0),
  // vidbot
  vec4(-50.0, 0.0, 3.0, 1.0),
  vec4(50.0, 0.0, 3.0, 1.0),
  vec4(50.0, 1.0, 3.0, 1.0),
  vec4(50.0, 1.0, 3.0, 1.0),
  vec4(-50.0, 1.0, 3.0, 1.0),
  vec4(-50.0, 0.0, 3.0, 1.0),
...
window.onload = function init() {
  ...
  window.addEventListener("keydown", function (e) {
    ...
    switch (e.keyCode) {
      case 87:	// w
        nextX = userXPos + userIncr * userXDir;
        nextZ = userZPos + userIncr * userZDir;
      ...
      case 65:	// a
        ...
        nextX = userXPos + userIncr * userZDir;
        // userZPos -= userIncr * userXDir;
        nextZ = userZPos - userIncr * userXDir;
        break;
      case 68:	// d
        // userXPos -= userIncr * userZDir;
        // userZPos += userIncr * userXDir;
    ...
    if (nextX < xMax && nextX > xMin) {
      userXPos = nextX;
    }
   
    if (nextZ < zMax && nextZ > zMin) {
      userZPos = nextZ;
    }
  });
